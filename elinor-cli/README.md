...
cargo run --release -p elinor-cli --bin elinor-compare -- \
  --input-csvs test-data/toy/pred_1.csv test-data/toy/pred_2.csv
```
...
```sh
cargo run --release -p elinor-cli --bin elinor-compare -- \
  --input-csvs test-data/toy/pred_1.csv test-data/toy/pred_2.csv test-data/toy/pred_3.csv
```
...
+----------+----------+----------+----------+
| System_1 | 1.0000   | 0.4014   | 1.0000   |
| System_2 | 0.4014   | 1.0000   | 0.6165   |
| System_3 | 1.0000   | 0.6165   | 1.0000   |
+----------+----------+----------+----------+
...
| P Value  | System_1 | System_2 | System_3 |
+----------+----------+----------+----------+
| System_1 | 1.0000   | 0.2148   | 1.0000   |
| System_2 | 0.2148   | 1.0000   | 0.1712   |
| System_3 | 1.0000   | 0.1712   | 1.0000   |
+----------+----------+----------+----------+
...
| P Value  | System_1 | System_2 | System_3 |
+----------+----------+----------+----------+
| System_1 | 1.0000   | 0.3768   | 0.9204   |
| System_2 | 0.3768   | 1.0000   | 0.2052   |
| System_3 | 0.9204   | 0.2052   | 1.0000   |
+----------+----------+----------+----------+
...
| P Value  | System_1 | System_2 | System_3 |
+----------+----------+----------+----------+
| System_1 | 1.0000   | 0.3100   | 0.9812   |
| System_2 | 0.3100   | 1.0000   | 0.2095   |
| System_3 | 0.9812   | 0.2095   | 1.0000   |
+----------+----------+----------+----------+
```
